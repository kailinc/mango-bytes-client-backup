...
var cartApi = __webpack_require__(11);
var itemApi = __webpack_require__(13);
var cartUi = __webpack_require__(39);
var getFormFields = __webpack_require__(6);
var store = __webpack_require__(1);
var frontCart = __webpack_require__(14);
var cartInfo = __webpack_require__(45);

// gets carts that belongs to the user
var filterCarts = function filterCarts(data) {
  var cartsArray = data.carts;
  var yourCarts = [];
...
var UpdateData = function UpdateData(data, id, quantity) {
  if (quantity > 0) {
    for (var i = 0; i < data.cart.products.length; i++) {
      for (var key in data.cart.products[i]) {
    ...
    for (var _i = 0; _i < data.cart.products.length; _i++) {
      if (data.cart.products[_i].item_id === id) {
        data.cart.products.splice(_i, 1);
      }
    }
  }
  return data;
...
var getItems = function getItems() {
  var fullItem = [];
  for (var i = 0; i < frontCart.cart.products.length; i++) {
    var itemId = frontCart.cart.products[i].item_id;
    itemApi.show(itemId).then(function (data) {
      return fullItem.push(data.item);
    }).then(function () {
      return cartUi.onViewCartSuccess(fullItem);
...
var onGetCarts = function onGetCarts() {
  if (!store.user) {
    $('#guestModal').modal('show');
  } else {
    $('#firstJumbo').css('display', 'none');
    cartApi.index().then(function (data) {
      return filterCarts(data);
    }).then(cartUi.onGetCartsSuccess).catch(cartUi.onGetCartsError);
  }
};

var onViewCart = function onViewCart() {
  var data = $(this).parent().data('id');
  var paymentStatus = $(this).parent().data('paid');
  if (paymentStatus) {
    cartUi.renderPaidSide(paymentStatus, data);
  } else {
    cartUi.renderUnpaidSide(paymentStatus, data);
  }
  cartApi.show(data).then(cartUi.onGetCartSuccess).then(function () {
    return getItems();
  }).catch(cartUi.onGetCartError);
};

var onDeleteCart = function onDeleteCart() {
  var data = $(this).data('id');
  cartApi.destroy(data).then(cartUi.onDestroyCartSuccess).then(onGetCarts).catch(cartUi.onDestroyCartError);
};

var onUpdateQuantity = function onUpdateQuantity() {
  var quantity = $(this).val();
  var cartId = $(this).parent().parent().data('id');
  if (quantity > 0) {
    var itemId = $(this).parent().data('item-id');
    var data = UpdateData(frontCart, itemId, quantity);
    data = JSON.stringify(data);
    cartApi.update(data, cartId).then(cartUi.onUpdateCartSuccess).catch(cartUi.onUpdateCartError);
  }
};
var onDeleteItem = function onDeleteItem() {
  var itemId = $(this).parent().data('item-id');
  var cartId = $(this).parent().parent().data('id');
  var data = UpdateData(frontCart, itemId, 0);
  data = JSON.stringify(data);
  console.log(data);
  cartApi.update(data, cartId).then(cartUi.onUpdateCartSuccess).catch(cartUi.onUpdateCartError);
};

var onCreateCart = function onCreateCart(data) {
  // data = JSON.stringify(data)
  cartApi.create(data).then(cartUi.onCreateCartSuccess).catch(cartUi.onCreateCartError);
};

var onUpdateCart = function onUpdateCart(data, id) {
  cartApi.update(data, id).then(cartUi.onUpdateCartSuccess).catch(cartUi.onUpdateCartError);
};
...
var userApi = __webpack_require__(20);
var cartApi = __webpack_require__(11);
var userUi = __webpack_require__(21);
var getFormFields = __webpack_require__(6);
var store = __webpack_require__(1);
var currentCart = __webpack_require__(7);
var cartEvent = __webpack_require__(8);

var onSignUp = function onSignUp(e) {
  e.preventDefault();
  ...
  if (pwd === pwdConfirm) {
    ...
    userApi.create(data).then(userUi.onSignUpSuccess).catch(userUi.onSignUpError);
...
var autoSignIn = function autoSignIn(data) {
  userApi.signIn(data).then(userUi.onSignInSuccess).catch(userUi.onSignInError);
};

var onSignIn = function onSignIn(e) {
  e.preventDefault();
  var data = getFormFields(e.target);
  userApi.signIn(data).then(userUi.onSignInSuccess).then(function () {
    return initCurrentCart();
  }).catch(userUi.onSignInError);
};

var onLogOut = function onLogOut() {
  userApi.logOut().then(userUi.onLogOutSuccess).catch(userUi.onLogOutError);
};

var onChangePwd = function onChangePwd(e) {
  e.preventDefault();
  var data = getFormFields(e.target);
  userApi.changePwd(data).then(userUi.onChangePwdSuccess).catch(userUi.onChangePwdError);
};

var onViewProfile = function onViewProfile(e) {
  e.preventDefault();
  var data = store.user.id;
  userApi.viewProfile(data).then(userUi.onViewProfileSuccess).catch(userUi.onViewProfileError);
};

var onUpdateProfile = function onUpdateProfile(e) {
  e.preventDefault();
  var data = getFormFields(e.target);
  userApi.updateUser(data).then(userUi.onUpdateProfileSuccess).catch(userUi.onUpdateProfileError);
};

var initCurrentCart = function initCurrentCart() {
  cartApi.index().then(function (data) {
    return cartEvent.filterCarts(data);
  }).then(function (data) {
...
var setCurrentCart = function setCurrentCart(data) {
  var cart = filterPaid(data);
  if (cart) {
...
var filterPaid = function filterPaid(data) {
...
var cleanCart = function cleanCart() {
  for (var i = 0; i < currentCart.cart.products.length; i++) {
...
var update = function update(data, id) {
  return $.ajax({
...
var item = __webpack_require__(46);
var cart = __webpack_require__(8);
...
var changePwd = function changePwd(data) {
  return $.ajax({
    method: 'PATCH',
...
var viewProfile = function viewProfile(data) {
  return $.ajax({
    method: 'GET',
...
var showUserProfileTemplate = __webpack_require__(22);
...
var onSignUpError = function onSignUpError(error) {
  console.log(error);
...
var onSignInError = function onSignInError(error) {
  console.log(error);
...
var onChangePwdError = function onChangePwdError(error) {
  console.log(error);
  $('#changePwdForm').get(0).reset();
...
var onViewProfileSuccess = function onViewProfileSuccess(data) {
  $('#main').css('display', 'none');
  $('#userProfile').css('display', 'block');
  $('#userInfo').empty();
  var showUserProfileHTML = showUserProfileTemplate({ user: data.user });
  $('#userInfo').append(showUserProfileHTML);
  console.log(data);
};

var onViewProfileError = function onViewProfileError(error) {
  console.log(error);
};

var onUpdateProfileSuccess = function onUpdateProfileSuccess() {
  $('#alertSuccess').css('display', 'block').text('Well Done! You have updated your profile!');
  $('#alertDanger').css('display', 'none');
};

var onUpdateProfileError = function onUpdateProfileError(error) {
  console.log(error);
...
module.exports = {
  ...
  onChangePwdError: onChangePwdError,
  onViewProfileError: onViewProfileError,
  onViewProfileSuccess: onViewProfileSuccess,
  onUpdateProfileError: onUpdateProfileError,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "      <div class=\"col-sm-4\">\n        <img src=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.img : stack1), depth0))
    + "\" style=\"width: 100px;\">\n        <h3>"
  ...
  return "      <p><span>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</span>: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.level : stack1), depth0))
    + "</p>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression, alias3=depth0 != null ? depth0 : (container.nullContext || {});

  return "\n<!-- FORM FOR UPDATING USER PROFILE -->\n<div style=\"margin-top:100px;\">\n  <form id=\"updateUserForm\">\n    <h3>Your Profile</h3>\n    <div class=\"form-group\">\n      <label for=\"inputEmail3\" class=\"col-sm-3 control-label\">First Name</label>\n      <div class=\"col-sm-9\">\n        <input type=\"text\" name=\"credentials[firstName]\" id=\"firstNameInput\" class=\"form-control\" value="
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.firstName : stack1), depth0))
    + " placeholder=\"First Name\">\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"inputEmail3\" class=\"col-sm-3 control-label\">Last Name</label>\n      <div class=\"col-sm-9\">\n        <input type=\"text\" name=\"credentials[lastName]\" id=\"lastNameInput\" class=\"form-control\" value="
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.lastName : stack1), depth0))
    + " placeholder=\"Last Name\">\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"inputEmail3\" class=\"col-sm-3 control-label\">Alias</label>\n      <div class=\"col-sm-9\">\n        <input type=\"text\" name=\"credentials[coderName]\" id=\"coderNameInput\" class=\"form-control\" value="
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.coderName : stack1), depth0))
    + " placeholder=\"Alias\">\n      </div>\n    </div>\n    <button type=\"submit\" class=\"btn btn-default\">Submit</button>\n  </form>\n\n  <!-- PLACE SHOWING A USER'S SUPER POWERS -->\n  <div class=\"row\">\n    <h1>Your Super Powers</h1>\n"
    + ((stack1 = helpers.each.call(alias3,((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.powers : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </div>\n\n\n\n  <!-- PLACE SHOWING A USER'S Skills -->\n    <h1>Your Skills: </h1>\n    <h3>{</h3>\n"
    + ((stack1 = helpers.each.call(alias3,((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.skills : stack1),{"name":"each","hash":{},"fn":container.program(3, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    <h3>}</h3>\n\n</div>\n";
...
var frontCart = __webpack_require__(14);
var currentCart = __webpack_require__(7);
var userEvent = __webpack_require__(10);
var showCartsTemplate = __webpack_require__(40);
var showCartTemplate = __webpack_require__(41);
var showPaidCartTemplate = __webpack_require__(42);
var showPaidSideCartTemplate = __webpack_require__(43);
var showUnpaidSideCartTemplate = __webpack_require__(44);

// function to loop through data to change date formate with filterDate()
var modifyTime = function modifyTime(data) {
  for (var i = 0; i < data.length; i++) {
...
var filterCart = function filterCart(data) {
  for (var key in data) {
...
var deleteId = function deleteId(data) {
...
var onGetCartsSuccess = function onGetCartsSuccess(data) {
  // console.log(data)
  var modDate = modifyTime(data);
  modDate.sort(function (a, b) {
    var nameA = a.isPaid.toString().toUpperCase();
    var nameB = b.isPaid.toString().toUpperCase();
    if (nameA < nameB) {
      return -1;
    }
    if (nameA > nameB) {
  ...
  $('#userProf').empty();
  console.log(modDate);
  var showCartsHTML = showCartsTemplate({ carts: modDate });
  $('#items').append(showCartsHTML);
};

var onGetCartsError = function onGetCartsError(error) {
  console.log(error);
};

var onGetCartSuccess = function onGetCartSuccess(data) {
...
var onGetCartError = function onGetCartError(error) {
  console.log(error);
};

var onDestroyCartSuccess = function onDestroyCartSuccess() {
  $('#userProfile').css('display', 'none');
  $('#firstJumbo').css('display', 'none');
...
var onViewCartSuccess = function onViewCartSuccess(data) {
  console.log('data of viewcart success is ', data);
  $('#userProfile').css('display', 'none');
  $('#firstJumbo').css('display', 'none');
  var showCartHTML = showCartTemplate({ items: data });
  $('#items').empty();
  $('#items').append(showCartHTML);
};

var onDestroyCartError = function onDestroyCartError(error) {
  console.log(error);
};

var onUpdateCartSuccess = function onUpdateCartSuccess(data) {};

var onUpdateCartError = function onUpdateCartError(error) {
  console.log(error);
};

var onCreateCartSuccess = function onCreateCartSuccess(data) {
...
var onCreateCartError = function onCreateCartError(error) {
  console.log(error);
};
...
var renderPaidSide = function renderPaidSide(status, id) {
  var data = { status: status, id: id };
  $('#userProf').empty();
  var showPaidSideCartTemplateHTML = showPaidSideCartTemplate({ data: data });
  $('#userProf').append(showPaidSideCartTemplateHTML);
};

var renderUnpaidSide = function renderUnpaidSide(status, id) {
  var data = { status: status, id: id };
  $('#userProf').empty();
  var showUnpaidSideCartTemplateHTML = showUnpaidSideCartTemplate({ data: data });
  $('#userProf').append(showUnpaidSideCartTemplateHTML);
};

module.exports = {
  onGetCartsSuccess: onGetCartsSuccess,
  onGetCartsError: onGetCartsError,
  onGetCartSuccess: onGetCartSuccess,
  onGetCartError: onGetCartError,
  onDestroyCartSuccess: onDestroyCartSuccess,
  onDestroyCartError: onDestroyCartError,
  onUpdateCartSuccess: onUpdateCartSuccess,
  onUpdateCartError: onUpdateCartError,
  onCreateCartSuccess: onCreateCartSuccess,
  onCreateCartError: onCreateCartError,
  onViewCartSuccess: onViewCartSuccess,
  renderPaidSide: renderPaidSide,
  renderUnpaidSide: renderUnpaidSide
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <div class=\"row grid\">\n      <div class=\"col-sm-5 carts\">\n        <p>Order#: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "</p>\n      </div>\n      <div class=\"col-sm-3 carts\">\n        <p>Date: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.updatedAt : stack1), depth0))
    + "</p>\n      </div>\n      <div class=\"col-sm-2 carts\">\n        <p>Paid: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.isPaid : stack1), depth0))
    + "</p>\n      </div>\n      <div class=\"col-sm-1 carts\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + " data-paid="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.isPaid : stack1), depth0))
    + ">\n        <button class=\"btn btn-default viewCartBtn\">View</button>\n      </div>\n    </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "\n<h1>Your Transaction History</h1>\n<hr>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.carts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <div class=\"col-sm-12 carts\">\n      <hr>\n          <div class=\"col-sm-6\" style=\"height: 200px; margin-bottom: 10px;\">\n            <img src=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.img : stack1), depth0))
    + "\">\n          </div>\n          <div class=\"col-sm-6\" style=\"height: 200px; margin-bottom: 10px;\">\n            <h2>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</h2>\n            <h3>$"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.basePrice : stack1), depth0))
    + "  DevCred: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.devCred : stack1), depth0))
    + " </h3>\n            <p>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.des : stack1), depth0))
    + "</p>\n            <p>Quantity: 1</p>\n          </div>\n      </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"row\">\n  <h1>Your Cart</h1>\n  <hr>\n    <div class=\"col-sm-12 carts\">\n      <hr>\n      <p>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.cart : depth0)) != null ? stack1.updatedAt : stack1), depth0))
    + "</p>\n      <p>Order#: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.cart : depth0)) != null ? stack1._id : stack1), depth0))
    + "</p>\n      <hr>\n      <div class=\"col-sm-8\">\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.cart : depth0)) != null ? stack1.products : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n      </div>\n      <div class=\"col-sm-4\" data-id="
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.cart : depth0)) != null ? stack1._id : stack1), depth0))
    + ">\n        <h4>$"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.cart : depth0)) != null ? stack1.totalPrice : stack1), depth0))
    + "</h4>\n        <h4>DevCred: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.cart : depth0)) != null ? stack1.totalDevCred : stack1), depth0))
    + "</h4>\n        <h4>Paid: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.cart : depth0)) != null ? stack1.isPaid : stack1), depth0))
    + "</h4>\n      </div>\n    </div>\n    <hr>\n</div>\n";
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n\n<p>Order#: "
    ...
    + "</p>\n<p>Paid: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.status : stack1), depth0))
    + "</p>\n<button class='clearCartBtn' data-id="
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.id : stack1), depth0))
    + ">Clear Cart</button>\n";
},"useData":true});
...
var itemApi = __webpack_require__(13);
var cartEvent = __webpack_require__(8);
var itemUi = __webpack_require__(47);
var getFormFields = __webpack_require__(6);
var store = __webpack_require__(1);
var currentCart = __webpack_require__(7);

var viewAll = function viewAll() {
  itemApi.index().then(itemUi.onIndexItemSuccess).catch(itemUi.onIndexItemError);
};

var onViewItem = function onViewItem() {
  $('#userProfile').css('display', 'none');
  var itemId = $(this).parent().data('id');
  itemApi.show(itemId).then(itemUi.onViewItemSuccess).catch(itemUi.onViewItemError);
};
...
var onAddToCart = function onAddToCart(e) {
  if (!store.user) {
    ...
    var data = { item_id: itemId, quantity: quantity };
...
var UniqueItem = function UniqueItem(data) {
...
var showItemsTemplate = __webpack_require__(48);
var showItemTemplate = __webpack_require__(49);

var onIndexItemSuccess = function onIndexItemSuccess(data) {
  $('#main').css('display', 'block');
  $('#items').empty();
  $('#firstJumbo').css('display', 'none');
  $('#userProf').empty();
  var showItemsHTML = showItemsTemplate({ items: data.items });
  $('#items').append(showItemsHTML);
};

var onIndexItemError = function onIndexItemError(error) {
  console.log(error);
};

var onViewItemSuccess = function onViewItemSuccess(data) {
  $('#items').empty();
  var showItemHTML = showItemTemplate({ item: data.item });
  $('#items').append(showItemHTML);
};

var onViewItemError = function onViewItemError(error) {
  console.log(error);
};
module.exports = {
  onIndexItemSuccess: onIndexItemSuccess,
  onIndexItemError: onIndexItemError,
  onViewItemSuccess: onViewItemSuccess,
  onViewItemError: onViewItemError
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <div class=\"col-sm-4\" data-id="
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"row\">\n    <div class=\"col-sm-5\">\n      <img src=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.img : stack1), depth0))
    + "\" style=\"width: 300px;\">\n    </div>\n    <div class=\"col-sm-5\">\n      <h3>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.name : stack1), depth0))
    + "</h3>\n      <h5>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.type : stack1), depth0))
    + "</h5>\n      <p>Price: $"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.basePrice : stack1), depth0))
    + "</p>\n      <p>devCred: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.devCred : stack1), depth0))
    + "</p>\n      <p>Description: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.des : stack1), depth0))
    + "</p>\n      <p>Attributes: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.attributes : stack1), depth0))
    + "</p>\n      <form class=\"itemForm form-horizontal\" data-quantity='1' data-id="
    ...
    + " data-attribute='"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.attributes : stack1), depth0))
    + "'>\n          <div class=\"form-group\">\n            <!-- <label for=\"inputEmail3\" class=\"col-sm-3 control-label\">Quantity</label>\n            <div class=\"col-sm-7\">\n              <input type=\"number\" name=\"credentials[email]\" class=\"form-control\" placeholder=\"ex. 10\">\n            </div> -->\n            <button type=\"button\" class=\"btn btn-default addCartBtn\">Add to Cart</button>\n          </div>\n      </form>\n    </div>\n</div>\n";
},"useData":true});
